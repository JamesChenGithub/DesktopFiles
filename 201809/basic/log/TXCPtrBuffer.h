...
#ifndef TXCPTRBUFFER_H
#define TXCPTRBUFFER_H
...
class TXCPtrBuffer {
  ...
  public:
    TXCPtrBuffer(void* _ptr, size_t _len, size_t _maxlen);
    TXCPtrBuffer(void* _ptr, size_t _len);
    TXCPtrBuffer();
    ~TXCPtrBuffer();
  ...
  private:
    TXCPtrBuffer(const TXCPtrBuffer& _rhs);
    TXCPtrBuffer& operator = (const TXCPtrBuffer& _rhs);
...
extern const TXCPtrBuffer KNullPtrBuffer;


#endif	// TXCPTRBUFFER_H
