...
@interface GuestViewController ()<ILiveMemStatusListener, ILiveScreenVideoDelegate>
...
{
    NSLog(@"frameData.identifier = %@ , srctype = %d", frameData.identifier, frameData.frameDesc.srcType);
}
