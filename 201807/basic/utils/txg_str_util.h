//
// Created by alderzhang on 2017/6/1.
//

#ifndef TXG_STR_UTIL_H
#define TXG_STR_UTIL_H
...
typedef str_util<std::string> str_util_a;
typedef str_util<std::wstring> str_util_w;

#endif    // TXG_STR_UTIL_H
